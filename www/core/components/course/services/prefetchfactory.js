 ...
 */
.factory('$mmPrefetchFactory', function ($mmSite, $mmFilepool, $mmUtil, $q, $mmLang, $mmApp, mmCoreDownloading, mmCoreDownloaded, $mmCourse) {
            ...
            return that.loadContents(module, courseId, true).then(function () {
                ...
                return that.getRevisionAndTimemodified(module, courseId, introFiles).then(function (data) {
                    ...
                    if (dirPath) {
                        ...
                        promises.push($mmFilepool.downloadOrPrefetchFiles(siteId, introFiles, prefetch, false, that.component, module.id));

                        // Download content files inside dirPath.
                        promises.push(downloadFn(siteId, contentFiles, that.component, module.id, data.revision, data.timemod, dirPath));
                    } else {
...
//# sourceMappingURL=prefetchfactory.js.map